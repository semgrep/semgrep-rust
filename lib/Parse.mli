...
(**
    Functions for parsing rust programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a rust program from a string into a typed OCaml CST.
...
(** Parse a rust program from a file into a typed OCaml CST.
